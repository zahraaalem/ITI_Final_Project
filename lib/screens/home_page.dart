              ...
              bottom: TabBar(
                ...
                tabs: [
                  Text(
                    ...
                    style: TextStyle(
                      color:
                          _tabBarIndex == 0 ? kSecondaryColor : kUnActiveColor,
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color:
                          _tabBarIndex == 1 ? kSecondaryColor : kUnActiveColor,
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color:
                          _tabBarIndex == 2 ? kSecondaryColor : kUnActiveColor,
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color:
                          _tabBarIndex == 3 ? kSecondaryColor : kUnActiveColor,
...
Widget productview(String productcatogory) {
  return StreamBuilder<QuerySnapshot>(
    stream:
        FirebaseFirestore.instance.collection(kProductsCollection).snapshots(),
